...
if ( isset( $_REQUEST[ 'btnCapNhat' ] ) ) {
  ...
  $sql = "update book set ";
  $sql .= "BookTitle = '" . $_REQUEST[ 'txtTenSach' ] . "','";
  $sql .= "BookDesc='" . $_REQUEST[ 'txtNoiDungTomTat' ] . "','";
  $sql .= "BookCatID=".$_REQUEST[ 'cmbTheLoai' ] . "','";
  $sql .= "BookAuthor='" . $_REQUEST[ 'txtTacGia' ] . "','";
  $sql .= "BookPubID=".$_REQUEST[ 'cmbNhaXuatBan' ] . "','";
  $sql .= "BookYear=".$_REQUEST[ 'txtNamXuatBan' ] . "','";
  $sql .= "BookPrice=".$_REQUEST[ 'txtGiaTien' ] . "')'";
...
<form action="" method="post" enctype="multipart/form-data" name="ThemSach">
  <fieldset style="width: 600">
    ...
    <table width="600" border="0">
      ...
      <tr>
        <td align="right"><input type="submit" name="btnCapNhat" value="Cập nhật" /></td>
